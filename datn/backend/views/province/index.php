...
$this->title = 'Danh sách các Tỉnh/Thành phố';
$this->params['breadcrumbs'][] = 'Tỉnh thành';
...
<div class="province-index">
    ...
    <p>
        <a href="javascript:void(0)" class="btn btn-success" onclick="openCreateProvince()">Thêm tỉnh thành</a>
    </p>
