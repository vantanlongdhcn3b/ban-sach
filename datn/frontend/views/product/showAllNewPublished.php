...
$this->title = $dataCat['cat_name'].' mới phát hành';
            ...
            <div class="container">
                <div class="row">
                    ...
                    if(!isset($_GET['page']) || $_GET['page']<2){
                     ?>
                        <h4 class="title-book" style="border-bottom: dashed 1px #ccc; padding: 10px"><?php echo $dataCat['cat_name'];  ?> phát hành trong tuần</h4><br/>
