            ...
            <div class="container">
                <div class="row">
                    ...
                    if(!isset($_GET['page']) || $_GET['page']<2){
                     ?>
                        <h4 class="title-book" style="border-bottom: dashed 1px #ccc; padding: 10px">Sách phát hành trong tuần</h4><br/>
                        <div class="blog-grid3">
                            <div class="row">
                                <?php 
                                foreach ($listNewProOneWeek as $key => $value) {
                    ...
                    <?php } ?>
                        <!--FILLTER WRAP START-->
                        <h4 class="title-book" style="border-bottom: dashed 1px #ccc; padding: 10px">Sách mới phát hành</h4><br/>
                        
                        <!--FILLTER WRAP END-->
                        <div class="blog-grid3" id="content-column">
                            <div class="row">
                            <?php 
                            foreach ($listNewPro as $key => $value) {
